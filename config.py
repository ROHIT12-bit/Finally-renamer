...
class Config(object):
    ...
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', 'anielitebackup').split(',')
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002746771935"))
    DUMP_CHANNEL = int(os.environ.get("DUMP_CHANNEL", "-1002746771935"))
